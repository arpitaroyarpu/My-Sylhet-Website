...
if (isset($_GET['verification'])) {
    ...
    $query = mysqli_query($conn, "SELECT * FROM users_login WHERE code='$verificationCode'");

    if (mysqli_num_rows($query) > 0) {
        $queryUpdate = mysqli_query($conn, "UPDATE users_login SET code='' WHERE code='$verificationCode'");
