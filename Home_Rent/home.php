        ...
        <section class="center">
            ...
            <form action="search.php" method="post">
                ...
                <div class="box">
                    ...
                    <input type="text" name="h_location" required maxlength="100" placeholder="enter area name"
                        class="input">
                </div>
                <div class="flex">
                    <div class="box">
        ...
        <div class="border-box">
            <div class="cardBox">
                <div class="card">
                    <h2>Buy House</h2>
                    <div class="content1">
                        <h3>How to Buy a House ?</h3>
                        <p>This is Sachin Samal, your tech mate!!! I love you all. Lets make this world a better place
                            for all of us. Keep prospering...Keep learning!!!</p>
                    </div>
                </div>
            </div>
            ...
            <div class="border-box">
                <div class="cardBox">
                    <div class="card">
                        ...
                        <div class="content1">
                            <h3>How to Buy a House ?</h3>
                            <p>This is Sachin Samal, your tech mate!!! I love you all. Lets make this world a better
                                place for all of us. Keep prospering...Keep learning!!!</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="border-box">
                        <div class="cardBox">
                            <div class="card">
                                ...
                                <div class="content1">
                                    <h3>How to Buy a House ?</h3>
                                    <p>This is Sachin Samal, your tech mate!!! I love you all. Lets make this world a
                                        better place for all of us. Keep prospering...Keep learning!!!</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="border-box">
                            <div class="cardBox">
                                <div class="card">
                                    ...
                                    <div class="content1">
                                        <h3>How to Buy a House ?</h3>
                                        <p>This is Sachin Samal, your tech mate!!! I love you all. Lets make this world
                                            a better place for all of us. Keep prospering...Keep learning!!!</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="box-container">
            ...
            if ($select_properties->rowCount() > 0) {
                while ($fetch_property = $select_properties->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    $select_user = $conn->prepare("SELECT * FROM `users_login` WHERE id = ?");
