...
<body>
    ...
    <section class="dashboard">
        ...
        <div class="box-container">
            ...
            <div class="box">
                <?php
                // Prepare and execute the query to fetch user profile information
                $select_profile = $conn->prepare("SELECT * FROM `users_login` WHERE id = ? LIMIT 1");
                $select_profile->execute([$user_id]);

                // Fetch the profile information from the executed query
